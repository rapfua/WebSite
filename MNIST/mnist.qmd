...
```{python}
#| label: def_get_similarity_def_draw_0
#| cache: true

def get_similarity_0(X_train_flat, n_neighbors, true_labels, b_original=True, MB=None):
...
def get_similarities_0(G, MB, X_train_flat, n_neighbors, n_clusters, affinity='precomputed'):
    ...
    similarity_original = get_similarity_0(X_train_flat, n_neighbors, true_labels)
    
    similarity_mb = get_similarity_0(
      X_train_flat=None,
      n_neighbors=None,
...
def print_similarities_0(G, MB, X_train_flat, n_neighbors, n_clusters, affinity='precomputed'):
    similarity_original, similarity_mb = get_similarities_0(G, MB, X_train_flat, n_neighbors, n_clusters, affinity)
...
print_similarities_0(G, mb_igraph, X_train_flat, n_neighbors=500, n_clusters=2, affinity='precomputed')
```
