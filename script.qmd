...
6 hybrid graph μ fixed n_neighbors varying
7.  Module dependencies
8.  Proof of THM 2.1
9.  Instructions to deploy website
10. First Passage Percolation On Inhomogeneous Random Graphs

4.  Graph with Gaussian clusters & ABBE prediction
5.  Plot with μ fixed & n_neighbors varying
6.  graph
...
<!-- #### First Passage Percolation Intuition -->
